...
var lord = currentNodeVersion.split('.');
var major = lord[0];
    ...
    .run(
      {
        ...
        npmGlobalPackages: ['@shark/react-scripts'],
      },
      {
        duplicates: true,
        showNotFound: true,
...
if (program.type) {
  if (
    ...
    console.error('Please set the correct type (full | web | npm) : ');
    console.log(
...
function createApp(name, verbose, useNpm, template) {
  ...
  execSync(`git clone ${templateGit}`);
